...
# Parameterized plots with {ggplot2} {background-color="#151C28"}
...
# Parameterized reports with Quarto {background-color="#151C28"}
...
# Parameterized text with Quarto {background-color="#151C28"}
...
# Rendering multiple reports {background-color="#151C28"}
...
# Next section {background-color="#151C28"}
